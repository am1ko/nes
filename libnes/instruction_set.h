...
/* $06 */   {&Cpu::ASL,     &Cpu::addrmode_zpg,   2U,     2U,    (  F_C|F_Z|F_N  ),   RESULT_MEM , false},
...
/* $0E */   {&Cpu::ASL,     &Cpu::addrmode_abs,   2U,     3U,    (  F_C|F_Z|F_N  ),   RESULT_MEM , false},
...
/* $16 */   {&Cpu::ASL,     &Cpu::addrmode_zpx,   2U,     2U,    (  F_C|F_Z|F_N  ),   RESULT_MEM , false},
...
/* $25 */   {&Cpu::AND,     &Cpu::addrmode_zpg,   2U,     2U,    (    F_Z|F_N    ),   RESULT_A   , false},
/* $26 */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
...
/* $35 */   {&Cpu::AND,     &Cpu::addrmode_zpx,   2U,     2U,    (    F_Z|F_N    ),   RESULT_A   , false},
/* $36 */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
/* $37 */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
/* $38 */   {&Cpu::SEC,     &Cpu::addrmode_imp,   2U,     1U,    (    NO_FLAGS   ),   RESULT_NONE, false},
/* $39 */   {&Cpu::AND,     &Cpu::addrmode_aby,   2U,     3U,    (    F_Z|F_N    ),   RESULT_A   , false},
...
/* $3D */   {&Cpu::AND,     &Cpu::addrmode_abx,   2U,     3U,    (    F_Z|F_N    ),   RESULT_A   , false},
/* $3E */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
...
/* $61 */   {&Cpu::ADC,     &Cpu::addrmode_inx,   2U,     2U,    (F_N|F_V|F_Z|F_C),   RESULT_A   , false},
...
/* $84 */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
/* $85 */   {&Cpu::STA,     &Cpu::addrmode_zpg,   3U,     2U,    (    NO_FLAGS   ),   RESULT_MEM , false},
/* $86 */   {&Cpu::STX,     &Cpu::addrmode_zpg,   3U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
...
/* $8C */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
/* $8D */   {&Cpu::STA,     &Cpu::addrmode_abs,   4U,     3U,    (    NO_FLAGS   ),   RESULT_MEM , false},
/* $8E */   {&Cpu::STX,     &Cpu::addrmode_abs,   4U,     3U,    (    NO_FLAGS   ),   RESULT_NONE, false},
...
/* $94 */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
/* $95 */   {&Cpu::STA,     &Cpu::addrmode_zpx,   4U,     2U,    (    NO_FLAGS   ),   RESULT_MEM , false},
/* $96 */   {&Cpu::STX,     &Cpu::addrmode_zpy,   4U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
...
/* $C6 */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
...
/* $CE */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
...
/* $D6 */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
...
/* $DE */   {&Cpu::NOP,     &Cpu::addrmode_imm,   0U,     2U,    (    NO_FLAGS   ),   RESULT_NONE, false},
