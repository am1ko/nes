...
class Cpu
{
    ...
    // --- INSTRUCTIONS ------------------------------------------------------------------------- //
    uint16_t ADC(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t AND(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t ASL(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t BCC(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t BCS(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t BEQ(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t BIT(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t BMI(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t BNE(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t BPL(uint16_t operand_addr, uint8_t &extra_cycles);
//  uint16_t BRK(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t BVC(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t BVS(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t CLC(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t CLD(uint16_t operand_addr, uint8_t &extra_cycles);
//  uint16_t CLI(uint16_t operand_addr, uint8_t &extra_cycles);
...
//  uint16_t DEC(uint16_t operand_addr, uint8_t &extra_cycles);
...
//  uint16_t INC(uint16_t operand_addr, uint8_t &extra_cycles);
    ...
    uint16_t LDA(uint16_t operand_addr, uint8_t &extra_cycles);
...
//  uint16_t ROL(uint16_t operand_addr, uint8_t &extra_cycles);
//  uint16_t ROR(uint16_t operand_addr, uint8_t &extra_cycles);
    ...
    uint16_t SEC(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t SED(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t SEI(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t STA(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t STX(uint16_t operand_addr, uint8_t &extra_cycles);
//  uint16_t STY(uint16_t operand_addr, uint8_t &extra_cycles);
    uint16_t TAX(uint16_t operand_addr, uint8_t &extra_cycles);
    ...
    uint16_t TYA(uint16_t operand_addr, uint8_t &extra_cycles);
...
struct CpuInstruction {
    uint16_t (Cpu::*instr_executor)(uint16_t, uint8_t&);
